...
const BurgerCard = ({image, title, price, reviews}:Props) => {
  return ( 
    ...
    <p className="mt-[0.5rem] text-black text-opacity-70">Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse quaerat ab illo dicta laboriosam nihil.</p>
    <div className="flex mt-[1.4rem] items-center justify-between">
        <h1 className="text-[25px] font-bold text-red-600">{price}</h1>
        <button className="px-4 py-2 hover:bg-green-600 transition-all duration-200 bg-orange-600 flex items-center rounded-md text-white">
